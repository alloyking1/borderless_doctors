    ...
    <div class="py-12">
        <div class="max-w-7xl md:mx-auto mx-6 sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm rounded-lg">
                ...
                <a href="{{ route('dashboard.request-a-doctor') }}" class="font-black text-2xl text-center bg-gradient-to-r from-blue-500 to-sky-500 text-white rounded-md p-6">Request a doctor</a>
