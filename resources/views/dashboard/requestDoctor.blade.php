                    ...
                    <div class="mt-4">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                                ...
                                <div class="flex items-center justify-center w-full">
                                    <label for="passport" class="flex flex-col items-center justify-center w-full h-64 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-white hover:bg-gray-100 dark:border-gray-600">
                                        <div class="flex flex-col items-center justify-center pt-5 pb-6">
                                            <p class="font-bold text-gray-800 text-3xl">Document front page</p>
                                            <svg class="w-8 h-8 mb-4 text-gray-500 dark:text-gray-400" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 16">
                                                <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 13h3a3 3 0 0 0 0-6h-.025A5.56 5.56 0 0 0 16 6.5 5.5 5.5 0 0 0 5.207 5.021C5.137 5.017 5.071 5 5 5a4 4 0 0 0 0 8h2.167M10 15V6m0 0L8 8m2-2 2 2"/>
                                            </svg>
                                            <p class="mb-2 text-sm text-gray-500 dark:text-gray-400"><span class="font-semibold">Click to upload</span> or drag and drop Front of passport</p>
                            ...
                            <div class="">
                                ...
                                <div class="flex items-center justify-center w-full">
                                    <label for="passport_back" class="flex flex-col items-center justify-center w-full h-64 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-white hover:bg-gray-100 dark:border-gray-600">
                                        <div class="flex flex-col items-center justify-center pt-5 pb-6">
                                            <p class="font-bold text-gray-800 text-3xl">Document back page</p>
                                            <svg class="w-8 h-8 mb-4 text-gray-500 dark:text-gray-400" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 16">
                                                <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 13h3a3 3 0 0 0 0-6h-.025A5.56 5.56 0 0 0 16 6.5 5.5 5.5 0 0 0 5.207 5.021C5.137 5.017 5.071 5 5 5a4 4 0 0 0 0 8h2.167M10 15V6m0 0L8 8m2-2 2 2"/>
                                            </svg>
                                            <p class="mb-2 text-sm text-gray-500 dark:text-gray-400"><span class="font-semibold">Click to upload</span> or drag and drop back of passport</p>
                                            <p class="mb-2 text-2xl text-gray-500 dark:text-gray-400"><span class="font-semibold">Drviers license</span> or Passport</p>
                                            <p class="text-xs text-gray-500 dark:text-gray-400">SVG, PNG, JPG or GIF (MAX. 800x400px)</p>
                                        </div>
                                        <input id="passport_back" name="passport_back" type="file" class="hidden" />
                                    </label>
                                </div> 
                                <x-input-error :messages="$errors->get('passport_back')" class="mt-2" />
                            </div>
